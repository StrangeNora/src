...
public class NursePage extends JFrame {
    ...
    private int buttonWidth = 260; // Set a larger width for buttons
    ...
    private JPanel createHomePanel() {
        JPanel panel = new JPanel(new BorderLayout());
        JLabel homeLabel = new JLabel("<html>Welcome Back Nurse!<br><br>This is the home page</html>", JLabel.CENTER);
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> new NursePage());
    }
}
